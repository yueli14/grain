...
40%;">
            <a href="javascript:" type="button" @click="getCode()"
...
//debugger
    ...
    getRegister(params) {
      console.log(params)
      register.registerUser(params).then(response => {
        //提示注册成功
    ...
    async getCode(mobile) {
      ...
      this.$refs.params.validateField("mobile", async () => {
        let r = await register.getCode(this.params.mobile)
